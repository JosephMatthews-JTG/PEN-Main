...
public class SaveSystem : MonoBehaviour
{
    ...
    protected static string savePath = "/pen.save";
    protected static string savePathBackUP = "/penbackup.save";
    ...
    public void ImportPlayer2(PersistentMainScript playerData)
    {
